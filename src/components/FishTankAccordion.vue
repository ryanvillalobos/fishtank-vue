<template>
  ...
  >
    <div
      ...
      ref="accordion"
    >
      <div :class="[$style.accordionHeadingWrapper]">
        <p
...
import { ChevronUp24, ChevronSmlUp24 } from "@fishtank/icons-vue";
...
export default class FishTankAccordion extends Vue {
  // Data
  visible = false;
  tabFocus = false;

  /**
   * Main heading text for large accordion
   */
  @Prop({
    type: String,
    required: false
  ...
  /**
   * Sub-heading text for large accordion
   */
  @Prop({
    type: String,
    required: false
  ...
  /**
   * Specify if accordion should be disabled
   */
  @Prop({
    type: Boolean,
    required: false,
  ...
  /**
   * Specify is accordion style should be small
   */
  @Prop({
    type: Boolean,
    required: false,
  ...
  //   required: false
  // })
  // fishtankAccordionGroupShared:AccordionComponentGroup

  @Inject({ default: { register() {}, unregister() {}, closeSiblings() {} } })
  fishtankAccordionGroupShared: AccordionComponentGroup;
  // Lifecycle
  mounted() {
...
.accordionDisabled .accordionSubHeading,
.accordionDisabled .accordionWrapperLg:hover .accordionSubHeading {
  color: var(--color-gray-lighter, $color-gray-lighter);
}
